...
import speed_layer.bolts.CalculatorBolt;
import speed_layer.bolts.ParserBolt;
...
public class SentimentAnalyzerTopology {
    ...
    public static void main(String[] args) throws Exception {
        ...
        builder.setBolt("parser_bolt", new ParserBolt(), 1).
                shuffleGrouping("twitter_spout");
        builder.setBolt("calculator_bolt", new CalculatorBolt(5), 3).
